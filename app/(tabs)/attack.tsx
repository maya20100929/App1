...
const styles = StyleSheet.create({
  container: { flex: 1, padding: 24, backgroundColor: '#FAF9FF', width: '100%', maxWidth: 760, alignSelf: 'center' },
  runningContainer: { paddingVertical: 16 },
  title: { fontSize: 26, fontWeight: '800', color: '#312A45', marginBottom: 8 },
  description: { color: '#817A91', marginBottom: 20 },
  input: { backgroundColor: '#fff', borderWidth: 1, borderColor: '#E4E0EF', borderRadius: 16, padding: 14, fontSize: 16 },
  inputPlaceholder: { color: '#a8a0a0' },
  inputFilled: { color: '#222' },
  timerCard: { alignItems: 'center', justifyContent: 'center', backgroundColor: '#fff', borderRadius: 24, paddingVertical: 36, marginTop: 24, borderWidth: 1, borderColor: '#EAE7F4' },
  timerCardRunning: { flex: 1, borderRadius: 28, marginTop: 16, paddingVertical: 0 },
  timerCardPaused: { backgroundColor: '#F5F2FF', borderColor: '#BDB4F1' },
  goalLabel: { color: '#817A91', marginBottom: 12 },
  timer: { fontSize: 56, fontWeight: '800', color: '#7464E8', fontVariant: ['tabular-nums'] },
  ...
  endButton: { backgroundColor: '#7464E8', borderRadius: 16, paddingVertical: 11, paddingHorizontal: 24 },
  endButtonText: { color: '#fff', fontWeight: '800', fontSize: 15 },
  resetButton: { alignSelf: 'center', paddingVertical: 8, paddingHorizontal: 16 },
  resetButtonText: { color: '#8D86A3', fontWeight: '600', fontSize: 13 },
  modalOverlay: { flex: 1, justifyContent: 'center', alignItems: 'center', padding: 24, backgroundColor: 'rgba(65, 40, 45, 0.35)' },
  pickerModal: { width: '100%', maxWidth: 340, backgroundColor: '#fff', borderRadius: 24, padding: 20 },
